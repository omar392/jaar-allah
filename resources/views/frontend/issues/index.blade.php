        ...
        <div class="d-table-cell">
            <div class="container">
                <div class="title-content">
                    <h2 style="font-family: tajawal">{{__('website.issues1')}}</h2>
                    <ul>
                        <li>
    ...
    <div class="container">
        <div class="section-title">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <span class="sub-title">{{__('website.issues')}}</span>
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="projects-item card-overlay">
                    <img src="{{ asset('upload/issue/' . $item->image) }}" alt="Projects">
                    <div class="inner">
                        <span>{{$item->title}}</span>
                        <h3 style="font-family: tajawal">
                            <a href="{{route('front.issues.details',[$item->id])}}">{{__('website.read')}}</a>
                        </h3>
                    </div>
                </div>
            </div>
