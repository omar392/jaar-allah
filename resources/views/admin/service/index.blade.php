        ...
        <div class="container-fluid">
            ...
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <h4 class="page-title" style="font-family: cairo;">الخدمات</h4>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row align-items-center">
                    @if(Auth::guard('admin')->user()->hasPermission('services-create'))
                    <div class="text-center">
                        <!-- Large modal -->
                        <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal"
                            data-target=".bs-example-modal-lg"><i class="fas fa-plus-circle"></i>إضافة خدمة جديدة</button>
                    </div>
                    @endif
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title mt-0" id="myLargeModalLabel" style="font-family: cairo;">إضافة خدمة جديدة</h5>
                                    ...
                                    <tbody>
                                        @foreach ($service as $item)
                                            <tr>
                                                ...
                                                <td>{{ $item->name_ar }}</td>
                                                <td>{{ $item->name_en }}</td>
                                                <td><img src="{{ !empty($item->image) ? url('upload/service/' . $item->image) : url('upload/no_image.jfif') }}"
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('service.edit', $item->id) }}"><button type="button"
                                                            class="float-left btn btn-info" data-size="sm" title="Edit"><i
                                                                class="fa fa-edit"></i></button></a>
                                                    @endif
                                                    &ensp;
                                                    @if(Auth::guard('admin')->user()->hasPermission('services-delete'))
