    ...
    <div class="container-fluid">
        ...
        <div class="page-title-box">
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <h4 class="page-title" style="font-family: cairo;">المدونة</h4>
                </div>
                <div class="col-sm-6">
                        ...
                        <div class="card-body">
                            <form action="{{route('service.update',$service->id)}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" name="name_ar"
                                            id="example-text-input" placeholder="عنوان الخدمة" value="{{$service->name_ar}}" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" name="name_en"
                                            id="example-text-input" placeholder="Article Title" value="{{$service->name_en}}" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input"
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" name="url"
                                            id="example-text-input" placeholder="الرابط" value="{{$service->url}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input"
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" name="description_ar" id="editor5">{!! $service->description_ar !!}</textarea>
                                    <script>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" name="description_en" id="editor">{!! $service->description_en !!}</textarea>
                                        <script>
