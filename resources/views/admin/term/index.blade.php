        ...
        <div class="container-fluid">
            ...
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <h4 class="page-title" style="font-family: cairo;">القيم الحاكمة</h4>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-right">
                            <li class="breadcrumb-item"><a href="{{ route('adminhome') }}">الرئيسية</a></li>
                            <li class="breadcrumb-item active">القيم الحاكمة</li>
                        </ol>
                    </div>
                </div> <!-- end row -->
                <br>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form class="float-left ml-1"
                                                        action="{{ route('term.destroy', $item->id) }}" method="POST">
                                                        @csrf
                                                        @method('delete')
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title mt-0" id="myLargeModalLabel"
                                                                        style="font-family: cairo;">تعديل  القيم الحاكمة</h5>
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="card-body">
                                                                        <form action="{{ route('term.update', $item->id) }}"
