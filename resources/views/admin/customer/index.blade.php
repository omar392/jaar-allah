                    ...
                    <div class="page-title-box">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="text-center">
                                <!-- Large modal -->
                                <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="fas fa-plus-circle"></i> إضافة عميل</button>
                            </div>
                            @endif
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title mt-0" id="myLargeModalLabel" style="font-family: cairo;">اضافة عميل</h5>
                            ...
                            <div class="card m-b-30">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$item->name_ar}}</td>
                                        <td>{{$item->name_en}}</td>
                                        <td><img src="{{ !empty($item->image) ? url('upload/customer/' . $item->image) : url('upload/no.png') }}"
                                        ...
                                        <td>
                                            @if(Auth::guard('admin')->user()->hasPermission('customers-update'))
                                            <a href="{{route('customer.edit',$item->id)}}"><button type="button"  class="float-left btn btn-info" data-size="sm" title="Edit"><i class="fa fa-edit"></i></button></a>
                                            @endif
                                            &ensp;
                                            @if(Auth::guard('admin')->user()->hasPermission('customers-delete'))
                                            <form class="float-left ml-1" action="{{route('customer.destroy',$item->id)}}" method="POST">
                                                @csrf
                                                @method('delete')
