                        ...
                        <div class="card-body">
                            <form action="{{route('gallery.update',$gallery->id)}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" name="name_ar" value="{{$gallery->name_ar}}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" name="name_en" value="{{$gallery->name_en}}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="input-preview__src" id="img" name="image" type="file" value="{{url(public_path('upload/gallery/' . $gallery->images))}}" />
                                    </div>
                                </div>
                                {{-- <div class="form-group row">
