                ...
                <div class="container-fluid">
                    ...
                    <div class="page-title-box">
                        <div class="row align-items-center">
                            <div class="col-sm-6">
                                <h4 class="page-title" style="font-family: cairo;"> المعرض</h4>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-right">
                                    <li class="breadcrumb-item"><a href="{{route('adminhome')}}">الرئيسية</a></li>
                                    <li class="breadcrumb-item active"> المعرض</li>
                                </ol>
                            </div>
                        </div> <!-- end row -->
                        <br>
                        <div class="row align-items-center">
                            ...
                            <div class="text-center">
                                <!-- Large modal -->
                                <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="fas fa-plus-circle"></i> إضافة صورة</button>
                            </div>
                            @endif
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title mt-0" id="myLargeModalLabel" style="font-family: cairo;">اضافة صورة</h5>
                            ...
                            <div class="card m-b-30">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$item->name_ar}}</td>
                                        <td>{{$item->name_en}}</td>
                                        <td><img src="{{ !empty($item->image) ? url('upload/gallery/' . $item->image) : url('upload/no.png') }}"
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('gallery.edit',$item->id)}}"><button type="button"  class="float-left btn btn-info" data-size="sm" title="Edit"><i class="fa fa-edit"></i></button></a>
                                            @endif
                                            &ensp;
